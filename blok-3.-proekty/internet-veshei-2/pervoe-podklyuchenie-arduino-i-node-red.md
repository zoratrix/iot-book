---
title: Первое подключение Ардуино и Node-red
---
...
\{% hint style="info" %} Запуск Node-red на компьютерах в "Смене":
...
Например, если мы настроим Inject на отправку *числа* 1 (например для включения лампочки), то "выходить" из этой ноды будет не число 1, а объект под названием msg с вот таким содержимым:
...
В терминале отладки вы должны увидеть сообщения, приходящие от Ардуино:
