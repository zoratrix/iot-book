...
Запустите Arduino IDE и откройте окно **Файл -> Настройки (File -> Preferences)**. Введите "<https://arduino.esp8266.com/stable/package_esp8266com_index.json>" в строку "**Дополнительные ссылки для менеджера плат**" (Additional boards manager URLs).
