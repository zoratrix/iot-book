...
При нажатии на кнопку "начать смену" отметка времени записывается в currentTme а затем в глобальную переменную smenaStart. Также обнуляется значение smenaStop
