...
[image:../../.gitbook/assets/image (48).png:::0,0,100,100:::center]
...
[image:../../.gitbook/assets/image (49).png:::0,0,100,100:::center]
...
[image:../../.gitbook/assets/image (47).png:::0,0,100,100:::center]
...
[image:../../.gitbook/assets/image (50).png:::0,0,100,100:::center]
...
\<pre class="language-arduino">`**// красный цвет digitalWrite(red,1);**` `digitalWrite(green, 0); digitalWrite(blue, 0);` \</pre>

\<pre class="language-arduino">`**// фиолетовый цвет digitalWrite(red,1);**` `digitalWrite(green, 0); digitalWrite(blue, 1);` \</pre>
...
[image:../../.gitbook/assets/image (46).png:::0,0,100,100:::center]
...
Еще один способ - использовать готовую библиотеку, например RGBLED от AlexGyver (документация тут <https://github.com/GyverLibs/RGBLED/tree/main>)
